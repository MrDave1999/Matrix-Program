...
#line 1 "C:\\Program Files\\Microsoft Visual Studio 12.0\\VC\\include\\mDynamic.h"
...
#line 1 "C:\\Program Files\\Microsoft Visual Studio 12.0\\VC\\include\\stdint.h"
...
#line 2386 "C:\\Program Files\\Microsoft Visual Studio 12.0\\VC\\include\\sal.h"
...
#line 44 "C:\\Program Files\\Microsoft Visual Studio 12.0\\VC\\include\\vadefs.h"
...
#line 126 "C:\\Program Files\\Microsoft Visual Studio 12.0\\VC\\include\\crtdefs.h"
...
#line 191 "C:\\Program Files\\Microsoft Visual Studio 12.0\\VC\\include\\crtdefs.h"
...
#line 532 "C:\\Program Files\\Microsoft Visual Studio 12.0\\VC\\include\\crtdefs.h"

#line 534 "C:\\Program Files\\Microsoft Visual Studio 12.0\\VC\\include\\crtdefs.h"


typedef unsigned short wchar_t;

#line 539 "C:\\Program Files\\Microsoft Visual Studio 12.0\\VC\\include\\crtdefs.h"
...
#line 660 "C:\\Program Files\\Microsoft Visual Studio 12.0\\VC\\include\\crtdefs.h"
...
#line 844 "C:\\Program Files\\Microsoft Visual Studio 12.0\\VC\\include\\crtdefs.h"
...
#line 7 "C:\\Program Files\\Microsoft Visual Studio 12.0\\VC\\include\\stdint.h"
...
#line 105 "C:\\Program Files\\Microsoft Visual Studio 12.0\\VC\\include\\stdint.h"
...
#line 116 "C:\\Program Files\\Microsoft Visual Studio 12.0\\VC\\include\\stdint.h"
...
#line 139 "C:\\Program Files\\Microsoft Visual Studio 12.0\\VC\\include\\stdint.h"
#line 140 "C:\\Program Files\\Microsoft Visual Studio 12.0\\VC\\include\\stdint.h"





#line 10 "C:\\Program Files\\Microsoft Visual Studio 12.0\\VC\\include\\mDynamic.h"
...
#line 11 "C:\\Program Files\\Microsoft Visual Studio 12.0\\VC\\include\\mDynamic.h"
...
#line 23 "C:\\Program Files\\Microsoft Visual Studio 12.0\\VC\\include\\stdlib.h"
...
#line 924 "C:\\Program Files\\Microsoft Visual Studio 12.0\\VC\\include\\stdlib.h"
...
#line 12 "C:\\Program Files\\Microsoft Visual Studio 12.0\\VC\\include\\mDynamic.h"


	
#line 16 "C:\\Program Files\\Microsoft Visual Studio 12.0\\VC\\include\\mDynamic.h"


	
#line 20 "C:\\Program Files\\Microsoft Visual Studio 12.0\\VC\\include\\mDynamic.h"


	
#line 24 "C:\\Program Files\\Microsoft Visual Studio 12.0\\VC\\include\\mDynamic.h"


	
#line 28 "C:\\Program Files\\Microsoft Visual Studio 12.0\\VC\\include\\mDynamic.h"
...
#line 81 "C:\\Program Files\\Microsoft Visual Studio 12.0\\VC\\include\\mDynamic.h"
...
void* _alloc_m(const uint8_t matrixid, const uint8_t size)
{
	...
	*(buf_ptr + matrixid) = (void**)malloc(dim[matrixid].new_rows * sizeof **(buf_ptr + matrixid));
	if (*(buf_ptr + matrixid) == ((void *)0))
	{
		puts("""Error allocating memory for the rows""");
		return ((void *)0);
	}
	for (uint32_t i = 0; i != dim[matrixid].new_rows; ++i)
	{
		
		(*(*(buf_ptr + matrixid) + i)) = malloc(dim[matrixid].cols * size);
		if ((*(*(buf_ptr + matrixid) + i)) == ((void *)0))
		{
			puts("""Error allocating memory for the columns""");
...
void* _realloc_m(const uint8_t matrixid, const uint8_t size, const _mode mode)
{
	...
	if (mode == ROWS || mode == ROWS_COLS)
	{
		...
		*(buf_ptr + matrixid) = (void**)realloc(ptrtemp, dim[matrixid].new_rows * sizeof **(buf_ptr + matrixid));
		if (*(buf_ptr + matrixid) == ((void *)0))
		{
			puts("""Error (re)allocating memory for the rows""");
			if (ptrtemp != ((void *)0))
			{
				*(buf_ptr + matrixid) = (void**)ptrtemp;
				dim[matrixid].new_rows = dim[matrixid].old_rows;
			}
			for(i = 0; i != (2); ++i) if (dim[i].new_rows != dim[i].old_rows) dim[i].new_rows = dim[i].old_rows;
			return ((void *)0);
		}
		if (dim[matrixid].new_rows > dim[matrixid].old_rows)
		{
	...
	if (mode == COLS || mode == ROWS_COLS)
	{
		...
		{
			ptrtemp = (*(*(buf_ptr + matrixid) + i));
			
			(*(*(buf_ptr + matrixid) + i)) = realloc(ptrtemp, dim[matrixid].cols * size);
			if ((*(*(buf_ptr + matrixid) + i)) == ((void *)0))
			{
				(*(*(buf_ptr + matrixid) + i)) = ptrtemp;
				puts("""Error (re)allocating memory for the columns""");
				dim[matrixid].old_rows = dim[matrixid].new_rows;
				for(i = 0; i != (2); ++i) if (dim[i].new_rows != dim[i].old_rows) dim[i].new_rows = dim[i].old_rows;
				return ((void *)0);
			}
...
int main(void)
{
	...
	for (uint8_t matrixid = 0; matrixid != (2); ++matrixid) { if (*(buf_ptr + matrixid) != ((void *)0)) { for (uint32_t __i___g = 0; __i___g != dim[matrixid].new_rows; ++__i___g) free((*(*(buf_ptr + matrixid) + __i___g))); free(*(buf_ptr + matrixid)); *(buf_ptr + matrixid) = ((void *)0); dim[matrixid].new_rows = 0; dim[matrixid].old_rows = 0; dim[matrixid].cols = 0; } };
	return xx;
}
...
#line 221 "C:\\Program Files\\Microsoft Visual Studio 12.0\\VC\\include\\mDynamic.h"


#line 224 "C:\\Program Files\\Microsoft Visual Studio 12.0\\VC\\include\\mDynamic.h"


#line 3 "main.c"
#line 1 "C:\\Program Files\\Microsoft Visual Studio 12.0\\VC\\include\\pscanf.h"
...
#line 10 "C:\\Program Files\\Microsoft Visual Studio 12.0\\VC\\include\\pscanf.h"
...
void _datareadEx(const char*const _format, void* const _var)
{
	...
	do
	{
		...
		if (!scanf(_format, _var))
		{
				...
				((!(_format[1] == 'c')) ? (((_format[1] == 'f' || _format[2] == 'f') ? (puts("""ERROR: Ingrese un valor flotante (decimal)""")) : (puts("""ERROR: Ingrese un valor entero""")))) : (puts("""ERROR: No se puede ingresar mas de un caracter""")));
			#line 35 "C:\\Program Files\\Microsoft Visual Studio 12.0\\VC\\include\\pscanf.h"
			while((_ch = getchar()) != '\n' && _ch != (-1));
			continue;
		}
		...
		if (_len >= 1 && !_value)
		{
				...
				((!(_format[1] == 'c')) ? (((_format[1] == 'f' || _format[2] == 'f') ? (puts("""ERROR: Ingrese un valor flotante (decimal)""")) : (puts("""ERROR: Ingrese un valor entero""")))) : (puts("""ERROR: No se puede ingresar mas de un caracter""")));
			#line 59 "C:\\Program Files\\Microsoft Visual Studio 12.0\\VC\\include\\pscanf.h"
			continue;
		}
...
#line 109 "C:\\Program Files\\Microsoft Visual Studio 12.0\\VC\\include\\pscanf.h"

#line 4 "main.c"
#line 1 "C:\\Program Files\\Microsoft Visual Studio 12.0\\VC\\include\\random.h"
...
#line 10 "C:\\Program Files\\Microsoft Visual Studio 12.0\\VC\\include\\random.h"

#line 5 "main.c"
#line 1 "C:\\Program Files\\Microsoft Visual Studio 12.0\\VC\\include\\assertx.h"
...
#line 9 "C:\\Program Files\\Microsoft Visual Studio 12.0\\VC\\include\\assertx.h"
...
#line 27 "C:\\Program Files\\Microsoft Visual Studio 12.0\\VC\\include\\assertx.h"
#line 6 "main.c"
#line 1 "c:\\users\\mrdave\\desktop\\prueba\\include/op.h"
...
void as_Matrix(const uint8_t option)
{
	...
	uint32_t 
		...
		j
	;
	for(i = 0; i != dim[MA].new_rows; ++i)
	{
		for(j = 0; j != dim[MA].cols; ++j)
		{
			(option == ADD) ? (printf("%d\t", (*((int*)*(*(buf_ptr + MA) + i) + j)) + (*((int*)*(*(buf_ptr + MB) + i) + j)))) : (printf("%d\t", (*((int*)*(*(buf_ptr + MA) + i) + j)) - (*((int*)*(*(buf_ptr + MB) + i) + j))));
		}
		puts("");
	}
}
...
void multi_Matrix(void)
{
	...
	for(rows_ma = 0; rows_ma != dim[MA].new_rows; ++rows_ma)
	{
		
		for(cols_mb = 0; cols_mb != dim[MB].cols; ++cols_mb)
		{
			
			for(rows_mb = 0; rows_mb != dim[MB].new_rows; ++rows_mb)
			{
				++cols_ma; 
				add = add + ((*((int*)*(*(buf_ptr + MA) + rows_ma) + cols_ma)) * (*((int*)*(*(buf_ptr + MB) + rows_mb) + cols_mb)));
			}
			printf("%d\t", add);
			cols_ma = -1;
			add = 0;
...
void Add_MD(void)
{
	...
	for(i = 0; i != dim[MA].new_rows; ++i)
	{
		for(space = i; space != 0; --space)
			printf("\t");
		printf("%d\n", (*((int*)*(*(buf_ptr + MA) + i) + i)) + (*((int*)*(*(buf_ptr + MB) + i) + i)));
	}
}
...
void Add_RD(void)
{
	...
	uint32_t 
		...
		space
	;
	int32_t n = dim[MA].new_rows;
	for(i = 0; --n != -1; ++i)
	{
		for(space = n; space != 0; --space)
			printf("\t");
		printf("%d\n", (*((int*)*(*(buf_ptr + MA) + i) + n)) + (*((int*)*(*(buf_ptr + MB) + i) + n)));
	}
}
...
void Add_Edge(void)
{
	...
	for(j = 0; j != dim[MA].cols; ++j)
		printf("%d\t", (*((int*)*(*(buf_ptr + MA) + 0) + j)) + (*((int*)*(*(buf_ptr + MB) + 0) + j)));
	puts("");
	
	for(i = 1; i != dim[MA].new_rows-1; ++i)
	{
		
		printf("%d", (*((int*)*(*(buf_ptr + MA) + i) + 0)) + (*((int*)*(*(buf_ptr + MB) + i) + 0)));
		
		for(j = 1; j != dim[MA].cols; ++j)
			printf("\t");
		
		printf("%d\n", (*((int*)*(*(buf_ptr + MA) + i) + dim[MA].cols-1)) + (*((int*)*(*(buf_ptr + MB) + i) + dim[MB].cols-1)));
	}
	
	for(j = 0; j != dim[MA].cols; ++j)
		printf("%d\t", (*((int*)*(*(buf_ptr + MA) + dim[MA].new_rows-1) + j)) + (*((int*)*(*(buf_ptr + MB) + dim[MB].new_rows-1) + j)));
	puts("");
}
...
void Add_WayT(void)
{
	...
	media = (dim[MA].cols-1) / 2;
	
	for(i = 1; i != dim[MA].new_rows; ++i)
	{
		
		for(j = 0; j != media; ++j)
			printf("\t");
		
		printf("%d\n", (*((int*)*(*(buf_ptr + MA) + i) + media)) + (*((int*)*(*(buf_ptr + MB) + i) + media)));
	}
}

#line 174 "c:\\users\\mrdave\\desktop\\prueba\\include/op.h"
#line 7 "main.c"
#line 1 "c:\\users\\mrdave\\desktop\\prueba\\include/dataentry.h"
...
uint8_t DataEntry(const uint8_t option)
{
	...
	if(option != MULTI)
	{
		do
		{
			while(1) { printf("Ingrese el numero de filas de la Matriz"); puts(""); _datareadEx("%d", &dim[MA].new_rows); if(!!!(!(!(dim[MA].new_rows >= 1)))) { printf("\nError: La dimension de la matriz debe ser mayor a 0\n"); printf("\n"); continue; } break; }
			while(1) { printf("Ingrese el numero de columnas de la Matriz"); puts(""); _datareadEx("%d", &dim[MA].cols); if(!!!(!(!(dim[MA].cols >= 1)))) { printf("\nError: La dimension de la matriz debe ser mayor a 0\n"); printf("\n"); continue; } break; }
			dim[MB].new_rows = dim[MA].new_rows;
			dim[MB].cols = dim[MA].cols;
	...
	else
	{
		do
		{
			while(1) { printf("Ingrese el numero de filas de la Matriz A"); puts(""); _datareadEx("%d", &dim[MA].new_rows); if(!!!(!(!(dim[MA].new_rows >= 1)))) { printf("\nError: La dimension de la matriz debe ser mayor a 0\n"); printf("\n"); continue; } break; }
			while(1) { printf("Ingrese el numero de columnas de la Matriz A"); puts(""); _datareadEx("%d", &dim[MA].cols); if(!!!(!(!(dim[MA].cols >= 1)))) { printf("\nError: La dimension de la matriz debe ser mayor a 0\n"); printf("\n"); continue; } break; }
			while(1) { printf("Ingrese el numero de filas de la Matriz B"); puts(""); _datareadEx("%d", &dim[MB].new_rows); if(!!!(!(!(dim[MB].new_rows >= 1)))) { printf("\nError: La dimension de la matriz debe ser mayor a 0\n"); printf("\n"); continue; } break; }
			while(1) { printf("Ingrese el numero de columnas de la Matriz B"); puts(""); _datareadEx("%d", &dim[MB].cols); if(!!!(!(!(dim[MB].cols >= 1)))) { printf("\nError: La dimension de la matriz debe ser mayor a 0\n"); printf("\n"); continue; } break; }
			if(!DetectRules(option)) continue;
			break;
		}while(1);
	}
	
	if(_realloc_m(MA, sizeof(int), ROWS_COLS) == ((void *)0)) return 1;
	if(_realloc_m(MB, sizeof(int), ROWS_COLS) == ((void *)0)) return 1;
	
	
	printf("\n-> Ingreso de datos de la matriz A (%d x %d):\n\n", dim[MA].new_rows, dim[MA].cols);
	for(i = 0; i != dim[MA].new_rows; ++i)
	{
		for(j = 0; j != dim[MA].cols; ++j)
		{
			printf("Ingrese el indice en la fila: %d - columna: %d", i, j); puts(""); _datareadEx("%d", &(*((int*)*(*(buf_ptr + MA) + i) + j)));
		}
	}
	
	
	printf("\n-> Ingreso de datos de la matriz B (%d x %d):\n\n", dim[MB].new_rows, dim[MB].cols);
	for(i = 0; i != dim[MB].new_rows; ++i)
	{
		for(j = 0; j != dim[MB].cols; ++j)
		{
			printf("Ingrese el indice en la fila: %d - columna: %d", i, j); puts(""); _datareadEx("%d", &(*((int*)*(*(buf_ptr + MB) + i) + j)));
		}
	}
	return 0;
}
...
uint8_t DetectRules(const uint8_t option)
{
	...
	switch(option)
	{
		...
		case EDGE:
			if(!!!(!(!(dim[MA].new_rows >= 3)))) { printf("\nError: El numero de filas de la matriz debe ser mayor a 2\n"); printf("\n"); return (0); }
			if(!!!(!(!(dim[MA].cols >= 3)))) { printf("\nError: El numero de columnas de la matriz debe ser mayor a 2\n"); printf("\n"); return (0); }
			break;
			
		case WAY_T:
			if(!!!(!(!(dim[MA].cols % 2 == 1)))) { printf("\nError: El numero de columnas debe ser impar\n"); printf("\n"); return (0); }
...
#line 112 "c:\\users\\mrdave\\desktop\\prueba\\include/dataentry.h"
#line 8 "main.c"
...
int mDynamic_main(void) 
{
	...
	while(1)
	{
		...
		printf("Ingrese una opcion <0-8>"); puts(""); _datareadEx("%c", &option);
		if(!!!(!(!(option >= '0' && option <= '8')))) { printf("\nError: Ingrese una opcion valida.\n"); printf("\n"); continue; }
		if((act == ENABLE) && (option >= '1' && option <= '7'))
		{
			if(DataEntry(option) == 1) return 1;
		}
		else if((option != '0' && option != '8') && (!DetectRules(option)))
		{
			puts("\nPresiona enter para continuar..."); _char = getchar(); if (_char != '\n') while((_char = getchar()) != '\n' && _char != (-1));
			continue;
		}
		switch(option)
		{
			case '0':
				if(!!!(!(!(dim[MA].new_rows != 0)))) { printf("\nError: Usted no ha ingresado ningun dato a las matrices A y B.\n"); printf("\n"); continue; }
				act = !act;
