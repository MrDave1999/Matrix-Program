...
#line 5 "main.c"
#line 1 "c:\\users\\mrdave\\desktop\\matrix-program[alpha-v0.1]\\op.h"
...
#line 163 "c:\\users\\mrdave\\desktop\\matrix-program[alpha-v0.1]\\op.h"
#line 6 "main.c"
...
int mDynamic_main(void) 
{
	...
	printf("Ingrese el numero de filas de la MA"); puts(""); _datareadEx("%d", &dim[MA].new_rows);
	printf("Ingrese el numero de columnas de la MA"); puts(""); _datareadEx("%d", &dim[MA].cols);
	
	printf("Ingrese el numero de filas de la MB"); puts(""); _datareadEx("%d", &dim[MB].new_rows);
	printf("Ingrese el numero de columnas de la MB"); puts(""); _datareadEx("%d", &dim[MB].cols);

	
	if(_alloc_m(MA, sizeof(int)) == ((void *)0)) return 1;
	if(_alloc_m(MB, sizeof(int)) == ((void *)0)) return 1;
